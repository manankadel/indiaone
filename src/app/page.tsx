      ...
      <section className="mx-auto max-w-[1160px] px-4 sm:px-6 pt-8 pb-6">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-6 items-start">
          <div>
            ...
            <h1 className="text-[34px] sm:text-[48px] font-[650] tracking-[-0.03em] leading-[0.95]">Tell us what<br />happened.<br /><span className="text-[#FF5A1F]">We find the right service.</span></h1>
            <p className="mt-4 text-[17px] leading-7 text-zinc-600 max-w-[560px]">IndiaOne is an <span className="font-semibold text-zinc-900">independent prototype</span> for Build What Moves India. One intent-first system, ten public-service modules, one case timeline. No government system is called. No real data is used.</p>

            <div id="start" className="mt-6 rounded-[20px] border border-zinc-200 bg-white p-4 sm:p-5 shadow-sm">
              <div className="text-xs font-semibold tracking-widest text-zinc-500">WHAT HAPPENED? — START HERE</div>
              <div className="mt-3 grid gap-3">
                ...
                >
                  <span>
                    <span className="block text-[17px] font-semibold">Money left my account</span>
                    <span className="block text-sm text-white/70">UPI / card / bank transfer — guide me in order</span>
                  </span>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button disabled className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-left opacity-60">
                ...
                <div className="flex flex-wrap gap-2 text-xs">
                  <span className="rounded-full bg-emerald-50 border border-emerald-200 px-3 py-1.5 text-emerald-800 flex items-center gap-1.5"><Check size={14} /> Demo incident prefilled — no OTP needed</span>
            ...
            <CardContent className="p-4 space-y-3">
              <div className="rounded-xl bg-amber-50 border border-amber-200 p-3 flex gap-3">
                ...
                <div className="text-sm leading-5">
                  ...
                  <div className="text-amber-800">We’ll prepare your transaction facts while you call. We never contact the bank for you.</div>
              ...
              <div className="rounded-xl border border-zinc-200 p-3">
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  {["Call 1930 (financial fraud helpline)", "Contact bank via verified number on card", "Block UPI / freeze card if needed", "Preserve SMS / screenshots — don’t delete"].map(t => (
              ...
              <div className="text-[11px] text-zinc-500 flex items-center gap-1.5"><Eye size={12} />All data synthetic. No government call made. Source-linked AI, citizen confirms.</div>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <Card>
          <CardContent className="p-5 sm:p-6 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-zinc-50 border border-zinc-200 p-4">
              ...
              <div className="mt-2 text-sm text-zinc-600">Tap “Money left my account” → Contain → Transaction → Evidence (2 fixtures) → Verify (confirm 7 facts) → Statement → Review → Simulate submit → Tracker. All deterministic, AI fallback included.</div>
              <div className="mt-3 text-xs font-mono bg-white border border-zinc-200 rounded-lg px-3 py-2">citizen@indiaone.demo / demo1234 — no OTP</div>
            </div>
