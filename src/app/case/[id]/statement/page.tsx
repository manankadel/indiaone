...
export default function StatementPage() {
  ...
  return (
    <div className="mx-auto max-w-[880px] px-4 sm:px-6 py-6">
      ...
      <p className="text-sm text-zinc-600 mt-1">Built only from confirmed facts + your words. Every sentence is editable. Separate facts / recollection / unknowns.</p>
      ...
      <Card className="mt-4">
        <CardContent className="p-4">
          ...
          <div className="mt-2 text-xs text-zinc-500">Reading level: plain & concise. Non-English original kept side-by-side when translated.</div>
        </CardContent>
      </Card>
